...
import { BarChart, XAxis, Legend } from 'recharts';
...
const Flow = () => { 
  ...
  const payload = [
    { value: 'Tribe Hyracotheriini', type: 'square', color: 'rgba(0, 255, 0, 0.4)'},
    { value: 'Tribe Chalicomorphini', type: 'square', color: 'rgba(255, 0, 255, 0.4)' },
    { value: 'Subfamily Equinae', type: 'square', color: 'rgba(255, 255, 0, 0.6)' },
    { value: 'Tribe Hipparionini', type: 'square', color: 'rgba(255, 0, 0, 0.4)' },
    { value: 'Tribe Protohippini', type: 'square', color: 'rgba(173, 216, 220, 1)' }
  ];
  ...
  return (
    <div>
      ...
      <div style={{fontSize: '16px', marginLeft: '20px', marginRight: '10px', marginTop: '10px'}}>The colors correspond to what groups the horses fall into, based on <a href="http://www.equinestudies.org/evolution_horse_2008/elsevier_horse_evolution_2008_pdf1.pdf">this text</a> from 2008. It is important to note that in the diagram, the colors surrounding each horse correspond to the most specific classification possible; thus, the early form of Merychippus is only under the Subfamily Equinae, while most other animals are more specific. Namely, both forms of Merychippus, Pliohippus, and Equus are under the Subfamly Equinae, while Miohippus and Mesohippus are both under Subfamily Anchitheriinae and Hyracotherium is under Subfamily Hyracotheriinae.</div>
    </div>
  );
}
