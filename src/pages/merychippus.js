    ...
    <div width={width} height={height}>
        <div style={{ display: "flex", flexDirection: "row-reverse",  backgroundImage: `url(${equusBg})`, backgroundSize: "cover"}}> 
            ...
            <div style={{ display: "flex", flexDirection: "column", flex:2 }}> 
                <div style={{border: "5px solid rgba(149, 165, 166, .7)", backgroundColor: 'rgba(149, 165, 166, .5)', borderRadius: '15px', marginTop: '40px', marginBottom: '410px', marginLeft: '40px', marginRight: '40px', display: "flex", flexDirection: 'column', flex: 1}}>
                    <div style={{fontSize: '40px', marginLeft: '10px', marginRight: '10px', marginTop: '10px'}}><strong>Merychippus</strong></div>
                    <div style={{fontSize: '16px', marginLeft: '10px', marginRight: '10px', marginTop: '10px', marginBottom: '10px'}}>The Merychippus was present 15 -7 million years ago in dusty and sand covered grasslands. Still, these animals had only three toes which was not very ideal for getting away from predators in these fields. These animals stood at about 1 meter tall which was about 3.5 feet tall. To adapt to its new environment and diet, these animals had teeth that were 18mm in length and 12.5 cm tooth span which allowed it to chew grasses and bushes as well as other young plant shoots/vegetation. </div>
                </div>
